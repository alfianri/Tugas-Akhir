...
\subsubsection{\textit{Male}}
    ...
    kondisi ini hanya akan dipilih dengan kondisi {"yawning"} dan {"yawning \& talking"} hal ini bertujuan untuk 
    ...
    berdasarkan fitur \textit{action} pada kategori male dapat dilihat pada 
    Gambar 4.4  \ref{Proporsi Data Male Berdasarkan "Action"} berikut.
    ...
    Setelah dilakukan pemilihan fitur dengan kondisi {"yawning"} dan {"yawning \& talking"}, di hasilkan jumlah data 
    untuk kategori \textit{male} sebanyak 56 video. Deskripsi untuk setiap data setelah sudah dilakukan pemilihan 
    fitur untuk kategori \textit{male} ditampilkan pada Tabel \ref{Data male setelah dilakukan pemilihan fitur} berikut.
